...
import { DEFAULT_SPRITE_SCALE, ENEMY_GREEN_CHICKEN_HEALTH, ENEMY_GREEN_CHICKEN_HORIZONTAL_VELOCITY, ENEMY_GREEN_CHICKEN_VERTICAL_VELOCITY, ENEMY_GREEN_CHICKEN_WAVE_FACTOR } from "../../config";
...
export class ChickenGreen extends GameObjects.Container
{
    ...
    constructor(scene: BaseScene, x: number, y: number)
    {
        ...
        this.mainSprite = scene.add.sprite(0, 0, 'chicken_green');
        ...
        this.mainSprite.play('chicken_green');
    ...
    public init(eventBusComponent: EventBusComponent)
    {
        ...
        this.verticalWavePatternInputComponent = new VerticalWavePatternInputComponent(ENEMY_GREEN_CHICKEN_WAVE_FACTOR);
