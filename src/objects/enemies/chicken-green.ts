...
import { ENEMY_GREEN_CHICKEN_HEALTH, ENEMY_GREEN_CHICKEN_HORIZONTAL_VELOCITY, ENEMY_GREEN_CHICKEN_VERTICAL_VELOCITY, ENEMY_GREEN_CHICKEN_WAVE_FACTOR } from "../../config";
